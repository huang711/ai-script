    ...
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="状态" prop="status">
        <el-select v-model="queryParams.status" placeholder="请选择状态" clearable>
          <el-option
            v-for="dict in dict.type.drama_project_status"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['drama:projects:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['drama:projects:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['drama:projects:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="projectsList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="状态" align="center" prop="status">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.drama_project_status" :value="scope.row.status"/>
        </template>
      </el-table-column>
...
<script>
import { listProjects, getProjects, delProjects, addProjects, updateProjects } from "@/api/drama/projects"

export default {
  name: "Projects",
  dicts: ['drama_project_status'],
  data() {
    return {
      // 遮罩层
      loading: true,
      ...
      rules: {
        ...
        creatorId: [
          { required: true, message: "创作者ID不能为空", trigger: "blur" }
        ],
        name: [
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('drama/projects/export', {
        ...this.queryParams
